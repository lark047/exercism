...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    pct = 100 * voltage * current / theoretical_max_power

    if pct >= 80:
        return "green"
    elif 80 > pct and pct >= 60:
        return "orange"
    elif 60 > pct and pct >= 30:
        return "red"
    elif 30 > pct:
        return "black"
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    """
    value = 100 * temperature * neutrons_produced_per_second / threshold

    if value < 90:
        return "LOW"
    elif 90 <= value and value <= 110:
        return "NORMAL"
    else:
        return "DANGER"
