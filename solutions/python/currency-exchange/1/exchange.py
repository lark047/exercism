...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
    rate_plus_fee = exchange_rate * ( 1 + spread / 100 )
    budget_after_exchange = exchange_money(budget, rate_plus_fee)
    return get_number_of_bills(budget_after_exchange, denomination) * denomination
